  ...
  return (
    <div style={{ padding: "32px 16px", maxWidth: 520, margin: "0 auto" }}>
              ...
              {s.teamsByCP && s.teamsByCP.length > 0 ? (
                s.teamsByCP.map((tc, tcIdx) => (
                  <div key={tc.cp + tcIdx} style={{ marginTop: 10, padding: 10, background: "rgba(0,0,0,0.15)", borderRadius: 8 }}>
                    ...
                    {tc.time && (
                      <div style={{
                        fontSize: 12, fontWeight: 600, color: "#fff", marginBottom: 6,
                        display: "inline-block", padding: "2px 8px", borderRadius: 6,
                        background: tc.time !== s.time ? "rgba(255,193,7,0.15)" : "rgba(255,255,255,0.06)",
                        border: "1px solid " + (tc.time !== s.time ? "rgba(255,193,7,0.4)" : "rgba(255,255,255,0.1)"),
                      }}>
                        🕐 {tc.time}
                        {tc.time !== s.time && (
                          <span style={{ color: "#FFC107", fontWeight: 400 }}> · alt interval decât al tău</span>
                        )}
                      </div>
                    )}
      ...
      <div style={{ display: "flex", gap: 8, justifyContent: "center", marginTop: 24 }}>
        <UReincarcaButton style={{ padding: "8px 16px" }} />
        {onLogout && (
          <button onClick={() => {
